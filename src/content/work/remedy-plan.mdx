...
<Gallery>
  <GalleryItem>
    <Still src={imageStillIdentity} alt="Graphic: Remedy Plan branding compilation" />
  </GalleryItem>
...
I spent much of 2015 helping to launch Remedy Plan Therapeutics, a Maryland-based biotech startup working to develop the first drugs that prevent cancer cells from multiplying. Since that time, Remedy Plan has raised nearly $3.4 million and identified 3 drugs to advance through the development pipeline. They are currently working to raise a $13 million Series A round to push their first drug through Phase 1 clinical trials.

I led the company's digital efforts, and was responsible for branding, design, and site development. I also played a substantial role in creating a crowdfunding campaign that raised the initial seed money for the new venture.

## Background

A microbiologist by day, Remedy Plan CEO Greg Crimmins had been working to form a new company [based on a _eureka_ moment in 2012](https://remedyplan.com/posts/the-eureka-moment). But funding for independent drug development is notoriously difficult to raise, and after years of roadblocks and a rapidly decreasing runway, the project's future was in jeopardy.
...
Over the next year, alongside Allison Crimmins and Katel LeDu, Remedy Plan was born over nights and weekends together, developing pitches, business plans, branding and communication strategies, and ultimately launching a crowdfunding campaign that raised over $100k on Indiegogo in 30 days.
...
Having just left a position developing new products and building large-scale ad campaigns at [iSL](https://isl.co), I was lucky to have exactly the kind of experience bringing a bunch of [giant](https://isl.co/work/the-socialsphere-data-visualization-in-the-motor-city-of-germany/), <Link to="/work/redds">wild</Link> ideas to life that this project needed.
...
Throughout this process I created all of Remedy Plan's visual design assets, designed and developed [remedyplan.com](https://remedyplan.com), and shot, directed, and edited a [90-second pitch video](https://www.youtube.com/watch?v=ctsfWUOm8Es&t=4s) for our Indiegogo campaign.

## The Sites

### Version 1

The first version of [remedyplan.com](https://remedyplan.com), launched alongside our campaign, was designed to explain a complex idea in an  accessible and inspiring way, to an audience without a background in science. We wanted to clearly outline why this approach was revolutionary, why it was worth investment, and why we could only bring it to life with their help.

It was also important to communicate the profound sense of gratitude and respect we felt for this audience, who were ultimately investing in us as people and their faith that we could make this moonshot possible.
