...
This project kickstarted a new era for <Link to="https://www.google.com/search?q=istrategylabs">ISL</Link> and defined the company's work for years afterward. Real-time interactive marketing campaigns were suddenly possible, we had a tech workflow and infrastructure to support projects at an enormous scale, and most importantly — the team saw just how capable we were together, and that it was possible for us to create something brand new by developing the skills we needed along the way.
