...
I've been excited to see the steady adoption of design systems over the last few years, and especially heartened by the emergence of <Link to="https://www.designbetter.co/design-engineering-handbook">_design engineering_</Link> as a crucial discipline in many organizations.

Below are a few examples of design systems I have implemented ranging from fully-documented component libraries to living styleguides, all of which have paid tremendous dividends in development time, UI resiliency, and developer empowerment.
...
<Browser description="Documentation created for Stackup UI, Promptworks' internal design system.">
...
<p><Link to="https://stackup-ui.netlify.app/">Stackup UI</Link> is an internal design system created at <Link to="https://promptworks.com">Promptworks</Link>, aimed at helping engineers build web and mobile apps with consistent, accessible, and resilient UI.</p>
...
At the time, Jeremy Keith and the Clearleft team's writing about establishing a <Link to="https://clearleft.com/posts/design-systems">_gestalt_</Link> was really resonating with me, and I proposed the idea of creating a shared design system with the following elements:
...
<Browser  description="A component library featuring sample code and technical documentation, built with Fractal.">
  <Video autoPlay loop muted>
...
<Browser collapse={true} description="A living styleguide created for promptworks.com.">
  <Still
...
<Browser description="A living styleguide created for SCTE.">
  <Still
...
<Browser description="A living styleguide created for the neighborhood of Roxborough, in northwest Philadelphia.">
  <Still
...
<Browser description="A living styleguide created for The Green Program.">
  <Still
